...
void bcast( void *buf, IntType count, DataType datatype, IntType root, CommType comm, ErrType *ierror )
{
    print::dbg( "[MPI Async. Overload Library] Intercepted MPI_Bcast" );

    shared_pointer<TicketType> waitCond = ibcast( buf, count, datatype, root, comm );
